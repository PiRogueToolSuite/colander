...
from colander.core.views.device_monitoring_views import (
    ...
    DeviceMonitoringDetailsView,
    device_monitoring_delete_view,
    device_monitoring_start_view,
    device_monitoring_stop_view,
    device_monitoring_create_vpn_peer_view,
    device_monitoring_release_vpn_peer_view,
    device_monitoring_get_vpn_peer_details_view,
)
...
case_contextualized_url_patterns = [
    ...
    path("device_monitoring", DeviceMonitoringCreateView.as_view(), name="device_monitoring_create_view"),
    ...
    path("device_monitoring/<slug:pk>/start", device_monitoring_start_view, name="device_monitoring_start_view"),
    path("device_monitoring/<slug:pk>/stop", device_monitoring_stop_view, name="device_monitoring_stop_view"),
    path("device_monitoring/<slug:pk>/create_vpn_peer", device_monitoring_create_vpn_peer_view, name="device_monitoring_create_vpn_peer_view"),
    path("device_monitoring/<slug:pk>/release_vpn_peer", device_monitoring_release_vpn_peer_view, name="device_monitoring_release_vpn_peer_view"),
    path("device_monitoring/<slug:pk>/get_vpn_peer_details", device_monitoring_get_vpn_peer_details_view, name="device_monitoring_get_vpn_peer_details_view"),
